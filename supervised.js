...
GameState.prototype.getReward = function(){
    return Math.min(Math.min(this.ship.x, this.game.width - this.ship.x), Math.min(this.ship.y, this.game.height - this.ship.y))/250 - 0.5;
};
